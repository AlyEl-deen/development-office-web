...
const fallbackProjects: Project[] = [
  ...
  {
    id: "fc-stadium",
    name: "FC Stadium Rooms",
    shortDescription: "A football room operations system for sessions, room monitoring, POS sales, and invoices.",
    fullDescription: "FC Stadium Rooms gives sports venue teams a practical command center for room sessions, live room status, point-of-sale activity, invoice handling, and operational visibility. It is designed for fast daily use at reception and management desks.",
    imageUrl: "/images/fc-stadium-logo.png",
    galleryImages: [
    ...
    category: "System",
    features: [
      "Room session start and tracking workflow",
      "Live room monitoring for active bookings",
      "Point-of-sale screen for venue purchases",
      "Invoice generation and review",
      "Operational interface tuned for front-desk speed",
    ],
    techStack: ["Tauri", "React", "TypeScript", "Tailwind CSS"],
